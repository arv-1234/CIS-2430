...
public class Menu {
    ...
    public static void main(String[] args){
        ...
        for(int i = 0; i<args.length; i++) {
         ...
         if(args.length == 0){
             System.out.println("Must have file name in command line. Exiting program....");
             System.exit(-1);
         }
        ...
        do{
            ...
            if(!(option.equalsIgnoreCase("Buy") || option.equalsIgnoreCase("B") || option.equalsIgnoreCase("Sell") || 
            option.equalsIgnoreCase("Update") || option.equalsIgnoreCase("U") || option.equalsIgnoreCase("getGain") || option.equalsIgnoreCase("G")
            || option.equalsIgnoreCase("Quit") || option.equalsIgnoreCase("Q") || option.equalsIgnoreCase("search"))){
                System.out.println("You have entered an invalid option. Enter valid input");
                System.out.println();
                continue;
            }
